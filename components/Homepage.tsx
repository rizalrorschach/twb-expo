...
export default function Homepage() {
  return (
    <section className="min-h-screen bg-slate-50 text-gray-900 flex items-center py-8 md:py-12">
      <div className="container mx-auto px-4 md:px-6 flex flex-col md:flex-row items-center">
        ...
        <div className="md:w-1/2 w-full h-[300px] md:h-[400px] lg:h-[500px] relative">
          <Image src="/placeholder.svg?height=800&width=600" alt="Campus Expo 2025" fill className="object-cover rounded-lg" sizes="(max-width: 768px) 100vw, 50vw" />
        </div>
      </div>
    </section>
  );
